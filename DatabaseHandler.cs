...
namespace bgpicker2
{
    ...
    public class DatabaseHandler
    {
        ...
        static string dbFileLocation = @"GamePicker.db";
        ...
        public static void AddBoardGame(string title, Vector2 players, Vector2 playTime, List<string> _types, List<string> _mechanics)
        {
            ...
            //check formatting for database

            if (title.Contains("'"))
            {
                string newTitle = title.Replace("'", "''");
                //MessageBox.Show(newTitle, title, MessageBoxButtons.OK);
                title = newTitle;
            }
        ...
        public static void AddBoardGame(BoardGame inBg)
        {
            AddBoardGame(inBg.GetName(), inBg.GetPlayerNum(), inBg.GetPlayTime(), inBg.GetTypes(), inBg.GetMechanics());
        }
        ...
        public static void RemoveGame(BoardGame selected)
        {
            ...
            sqlComm.CommandText = "DELETE FROM BoardGames WHERE GameTitle = '" + title + "';";
            sqlComm.ExecuteNonQuery();
        }
